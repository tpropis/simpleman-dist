...
/** Build a spirits-bottle silhouette as a lathe profile (radius, height). */
function useBottleProfile() {
  return useMemo(() => {
...
function Bottle({
  ...
  // Inner liquid profile — lower body only, slightly inset from the glass.
